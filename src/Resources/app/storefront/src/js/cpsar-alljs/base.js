...
(function ($) {
    ...
    FUNCSAR.defaultAddressCheckbox = function() {
    ...
    FUNCSAR.CpSarShopNavigation = function() {
        $('#navigation').CpShopNav();
        $('#navigation1').CpShopNav();
        $('#navigation2').CpShopNav();
        $('#navigation3').CpShopNav();
    };

    FUNCSAR.onTabActiveRefreshSlider = function() {
    ...
    FUNCSAR.primarySlider = function() {
    ...
    // Bind all sliders into the page
    FUNCSAR.productSlider = function() {
    ...
    // Testimonial Slider
    FUNCSAR.testimonialSlider = function() {
    ...
    FUNCSAR.appConfiguration = function() {
        $('body').removeAttr('class');
        $('.preloader').removeClass('is-active');
    };

    // Bind isotope filter plugin
    FUNCSAR.isotopeFilter = function() {
    ...
    FUNCSAR.timerCountDown = function() {
    ...
    // Input Counter
    FUNCSAR.initInputCounter = function() {
    ...
    // Blog Post Gallery
    FUNCSAR.blogPostGallery = function() {
    ...
    // Blog Post Masonry
    FUNCSAR.blogPostMasonry = function() {
    ...
    // Blog Post Video
    FUNCSAR.blogPostVideo = function() {
    ...
    FUNCSAR.blogPostEmbedVideo = function() {
    ...
    // Product Detail Init
    FUNCSAR.productDetailInit = function() {
    ...
    FUNCSAR.modalProductDetailInit = function() {
    ...
    FUNCSAR.shopCategoryToggle = function() {
    ...
    FUNCSAR.shopPerspectiveChange = function() {
    ...
    FUNCSAR.shopSideFilter = function() {
    ...
    FUNCSAR.showNewsletterModal = function() {
    ...
    $(window).on('load',function () {
        ...
        FUNCSAR.tabSlider();
        FUNCSAR.onTabActiveRefreshSlider();
        FUNCSAR.brandSlider();
        FUNCSAR.testimonialSlider();
        FUNCSAR.appConfiguration();
        FUNCSAR.isotopeFilter();
        FUNCSAR.timerCountDown();
        FUNCSAR.initInputCounter();
        FUNCSAR.blogPostGallery();
        FUNCSAR.blogPostVideo();
        FUNCSAR.blogPostEmbedVideo();
        FUNCSAR.blogPostMasonry();
        FUNCSAR.productDetailInit();
        FUNCSAR.modalProductDetailInit();
        FUNCSAR.shopCategoryToggle();
        FUNCSAR.shopPerspectiveChange();
        FUNCSAR.shopSideFilter();
})(jQuery);